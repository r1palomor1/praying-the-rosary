...
export function AIChatWindow({ contextStr, topicName, source = 'Daily Readings', initialMessage, language = 'en', startTab = 'chat' }: AIChatWindowProps) {
  ...
  const PROMPTS: Record<string, Record<string, string[]>> = {
    en: {
      ...
      'Rosary': [
        'Summarize this mystery and its spiritual fruit.',
        'Explain the theological depth behind this mystery.',
        'How does Mary\'s role in this mystery bring us closer to Christ?',
        'What practical virtue can I practice based on this mystery?',
        'Give me 3 personal reflection questions for this decade.',
        'Write a short prayer meditating on this decade.',
      ],
      'default': [
    ...
    es: {
      ...
      'Rosary': [
        'Resume este misterio y su fruto espiritual.',
        'Explica la profundidad teológica detrás de este misterio.',
        '¿Cómo nos acerca a Cristo el papel de María en este misterio?',
        '¿Qué virtud práctica puedo cultivar basada en este misterio?',
        'Dame 3 preguntas de reflexión personal para esta década.',
        'Escribe una breve oración meditando en esta década.',
      ],
      'default': [
